...
exports.createSubElements = exports.lookupType = exports.globalHelper = exports.channelDescription = exports.sensorDescriptions = exports.outputSettings = exports.outputDescription = exports.binaryInputDescriptions = void 0;
exports.binaryInputDescriptions = [
    {
...
function lookupType(key, value) {
    ...
    if (!key)
        return type;
    if (exports.globalHelper.find(o => o.name == key)) {
        let valObj = {};
        if (typeof value != 'undefined' &&
            ((value && value.length > 0) || value === 0 || value)) {
            if (exports.globalHelper) {
                const gHI = exports.globalHelper.find((o) => o.name == key);
                if (gHI) {
                    const typeKey = gHI.type;
                    if (typeKey) {
...
function createSubElements(obj) {
    ...
    for (let [key, value] of Object.entries(obj)) {
        if (value &&
            ...
            if (key && exports.globalHelper.find(o => o.name == key)) {
...
//# sourceMappingURL=messageMapping.js.map