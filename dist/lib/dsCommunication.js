...
exports._vdcSendAnnounceDevice =
  exports._genericResponse =
  exports._vdcSendPong =
  exports._vdcSendAnnounceVdc =
  exports._vdsmResponseHello =
  exports._vdcPushChannelStates =
  exports._vdcSendPushProperty =
  exports._vdcResponseGetProperty =
    void 0;
      ...
      decodedMessage.vdsmRequestGetProperty.query.forEach(p => {
        ...
        if (p.name == 'outputSettings') {
            ...
            device.outputSettings.forEach(desc => {
              ...
              for (const [key, value] of Object.entries(desc)) {
                if (
                  ...
                  if (
                    messageMapping_1.outputSettings &&
                    ((_a = messageMapping_1.outputSettings.find(
                      o => o.name == key
                    )) === null || _a === void 0
                      ? void 0
                      : _a.type) == 'elements'
                    ...
                    const valObj = {};
                    const keyObj = messageMapping_1.outputSettings.find(
                      o => o.name == key
                    );
                    const objKey =
                      keyObj === null || keyObj === void 0
                        ? void 0
                        : keyObj.type;
                    valObj[objKey] = value;
                    elements.push({
          ...
          if (device.outputDescription) {
            device.outputDescription.forEach(desc => {
              ...
              for (const [key, value] of Object.entries(desc)) {
                if (
                  key &&
                  messageMapping_1.outputDescription.find(o => o.name == key)
                ) {
                  const valObj = {};
                  const keyObj = messageMapping_1.outputSettings.find(
                    o => o.name == key
                  ...
                  const objKey =
                    keyObj === null || keyObj === void 0 ? void 0 : keyObj.type;
                  valObj[objKey] = value;
                  elements.push({
                    name: key,
                    value: valObj,
          ...
          if (Array.isArray(device.buttonInputSettings)) {
            const biElements = [];
            device.buttonInputSettings.forEach((cdObj, i) => {
              if (
                cdObj &&
                typeof cdObj === 'object' &&
                !Array.isArray(cdObj) &&
          ...
          if (device.sensorDescriptions) {
            device.sensorDescriptions.forEach(desc => {
              ...
              for (const [key, value] of Object.entries(desc)) {
                if (
                  key &&
                  messageMapping_1.sensorDescriptions.find(o => o.name == key)
                ) {
                  const valObj = {};
                  const keyObj = messageMapping_1.outputSettings.find(
                    o => o.name == key
