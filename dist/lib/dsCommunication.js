                    ...
                    if (device.outputSetting) {
                        device.outputSetting.forEach((desc) => {
                            ...
                            for (const [key, value] of Object.entries(desc)) {
                                if (key && messageMapping_1.outputSetting.find((o) => o.name == key)) {
                                    if (messageMapping_1.outputSetting && ((_a = messageMapping_1.outputSetting.find((o) => o.name == key)) === null || _a === void 0 ? void 0 : _a.type) ==
                                        "elements") {
                                        const subElements = [];
                                        value.forEach((s) => {
                                            subElements.push({
